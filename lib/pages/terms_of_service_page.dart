...
class TermsOfServicePageContent extends StatelessWidget {
  const TermsOfServicePageContent({super.key});

  static const String _assetPath = 'assets/legal/terms_of_service.md';
  ...
  Widget _buildContent(AsyncSnapshot<String> snapshot) {
    ...
    if (data.isEmpty) {
      return const Center(
        child: Text(
          'Terms of Service content is empty.',
          style: TextStyle(fontSize: 16, color: Colors.redAccent),
        ),
      );
    }
