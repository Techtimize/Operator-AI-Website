...
class AppColor {
  ...
  static const Color secondaryLighterTextColor = Color(0xFFA3ADA8);  
  static const Color darkTextColor = Color(0xFF232323);
  static const Color secondaryTextColor = Color(0xFF6C7570);
   
  // Icon Color
  static const Color primaryIconColor = Color(0xFFECECF0);
  static const Color primaryIconColorDark = Color(0xFFD8D8DC);
  ...
  static const Color backgroundStartColor = Color(0xFF3A2DB0);
  static const Color backgroundEndColor = Color(0xFF5B2C83);

  static const Color primaryBrightTextColor = Color(0xFFD234AC);
  static const Color primaryBrightEndTextColor =Color(0xFFD81B60);
  ...
  static  Color secondaryBorderColorDark = Colors.white.withOpacity(0.3);
  static const Color darkBorderColor = Color(0xFF6C7570);


  //Error and Validation Color
  static const Color errorColor = Color(0xFFD32F2F);
  static const Color selectColor = Color(0xFF00C853);
