...
class _FinalSectionsState extends State<FinalSections> {
  ...
  Widget build(BuildContext context) {
    ...
    // Slightly larger bottom padding to avoid RenderFlex overflow on small screens
    final double containerBottomPadding = isMobileRange ? 28 : (isTabletRange ? 28 : 32);
      ...
      child: Column(
        children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    isMobileRange ? const SizedBox(height: 12) : const Spacer(),
                                    Row(
                                      children: [
                                        Container(
                                          width: 12,
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: sectionHorizontalPadding),
            child: ShaderMask(
              shaderCallback: (bounds) => const LinearGradient(colors: [Color(0xFF9333EA), Color(0xFFDB2777)]).
                  createShader(Rect.fromLTWH(0, 0, bounds.width, bounds.height)),
              child: Text(
                'Our Team Structure',
                style: TextStyle(
          ...
          Padding(
            ...
            child: Container(
              ...
              padding: EdgeInsets.fromLTRB( // keep top/left/right but allow extra bottom padding
                isMobileRange ? 16 : 28,
                isMobileRange ? 16 : 28,
                isMobileRange ? 16 : 28,
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      crossAxisSpacing: isMobileRange ? 12 : 20,
                      mainAxisSpacing: isMobileRange ? 14 : 22,
                      // smaller ratio -> taller items
                      childAspectRatio: isMobileRange
                          ? 3.6
                          : (isLargePhoneRange
                              ? 2.6
                              : (isTabletRange ? 2.2 : 2.6)),
                    ),
                            ...
                            Row(
                              children: [
                                AnimatedContainer(
                                  ...
                                  height: 40,
                                  decoration: BoxDecoration(
                                      gradient: LinearGradient(colors: dept['color'] as List<Color>),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Center(child: Text(role['count'].toString(), style: TextStyle(fontSize: 11, color: hoveredDept == index ? Colors.white : const Color(0xFF6B7280), fontWeight: FontWeight.bold))),
                                      )
                                    ],
                                  ),
                                );
                  ...
                  GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      mainAxisSpacing: isMobileRange ? 14 : 18,
                      childAspectRatio: isMobileRange ? 2.8 : (isLargePhoneRange ? 1.8 : (isTabletRange ? 1.6 : 1.6)),
                    ),
                    itemBuilder: (context, index) {
                      final stats = [
                        {
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Flexible(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.bold,
                                    foreground: Paint()
                                      ..shader = LinearGradient(colors: [stat['color'] as Color, _getNextColor(stat['color'] as Color)]).createShader(const Rect.fromLTWH(0, 0, 50, 30)),
                                  ),
                                  textAlign: TextAlign.center,
                                  softWrap: true,
                              ...
                              SizedBox(height: AppSpaces.vertical(context, AppSize.xs)),
                              Flexible(
                                child: Text(stat['label'].toString(), style: TextStyle(fontSize: _rFont(context, mobile: 10, tablet: 11, desktop: 12), color: const Color(0xFF6B7280)), textAlign: TextAlign.center),
                              ),
                            ],
                          ),
                        ),
